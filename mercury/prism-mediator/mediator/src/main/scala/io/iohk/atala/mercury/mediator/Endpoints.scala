...
//
//  val sendMessageServerEndpoint: ZServerEndpoint[DidComm & MailStorage, Any] = {
...
//    )
//
//  val all: List[ZServerEndpoint[DidComm & MailStorage, Any]] =
//    List(
//      createInvitationServerEndpoint.widen[DidComm & MailStorage],
//      retrieveMessagesServerEndpoint.widen[DidComm & MailStorage],
//      registerMediatorServerEndpoint.widen[DidComm & MailStorage],
