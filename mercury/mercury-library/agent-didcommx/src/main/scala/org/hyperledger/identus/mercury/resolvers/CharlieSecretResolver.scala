...
object CharlieSecretResolver {
  ...
  private val jwkKey1 =
    // "kid":"${org.hyperledger.identus.charlie}#6LSiseNCbbtmG6ascxpPvoyT8ewrWdtJZxwmPNxYAPWxzM8",
  ...
  private val jwkKey2 = // example from did:example:alice#key-1
    // "kid":"${org.hyperledger.identus.charlie}#6MkgLBGee6xL5KH8SZmqmKmQKS2o1qd4RG4dSmjtRGTfsxX",
  ...
  private val secretKey1 = new Secret(
    org.hyperledger.identus.charlie + "#6LSiseNCbbtmG6ascxpPvoyT8ewrWdtJZxwmPNxYAPWxzM8",
    VerificationMethodType.JSON_WEB_KEY_2020,
    new VerificationMaterial(VerificationMaterialFormat.JWK, jwkKey1)
  )
  private val secretKeyAgreement1 = new Secret(
    org.hyperledger.identus.charlie + "#6MkgLBGee6xL5KH8SZmqmKmQKS2o1qd4RG4dSmjtRGTfsxX",
    VerificationMethodType.JSON_WEB_KEY_2020,
  ...
  val secretResolver = new SecretResolverInMemory(
    Map(
      (org.hyperledger.identus.charlie + "#6LSiseNCbbtmG6ascxpPvoyT8ewrWdtJZxwmPNxYAPWxzM8") -> secretKey1,
      (org.hyperledger.identus.charlie + "#6MkgLBGee6xL5KH8SZmqmKmQKS2o1qd4RG4dSmjtRGTfsxX") -> secretKeyAgreement1,
      (org.hyperledger.identus.charlie) -> secretKeyAgreement1
    ).asJava
  )
  ...
  @main def testPeerDidDoc() = {
    println(
      org.didcommx.peerdid.PeerDIDResolver
        .resolvePeerDID(
          org.hyperledger.identus.charlie,
