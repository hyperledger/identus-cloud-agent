...
object AnoncredMockCredentialService extends Mock[AnoncredCredentialService] {
  ...
  override val compose: URLayer[mock.Proxy, AnoncredCredentialService] = ZLayer {
    for {
      proxy <- ZIO.service[Proxy]
    } yield new AnoncredCredentialService {
