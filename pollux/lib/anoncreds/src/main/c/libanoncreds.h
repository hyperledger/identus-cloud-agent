...
ErrorCode anoncreds_create_credential_request(
    FfiStr prover_did, ObjectHandle cred_def, ObjectHandle master_secret,
    FfiStr master_secret_id, ObjectHandle cred_offer, ObjectHandle *cred_req_p,
...
ErrorCode anoncreds_create_presentation(
    ...
    ObjectHandle master_secret, struct FfiList_ObjectHandle schemas,
...
ErrorCode anoncreds_create_revocation_status_list(
    FfiStr rev_reg_def_id, ObjectHandle rev_reg_def, int64_t timestamp,
    int8_t issuance_by_default, ObjectHandle *rev_status_list_p);
...
anoncreds_process_credential(ObjectHandle cred, ObjectHandle cred_req_metadata,
                             ObjectHandle master_secret, ObjectHandle cred_def,
...
ErrorCode anoncreds_verify_presentation(
    ...
    struct FfiList_ObjectHandle rev_status_list, int8_t *result_p);
