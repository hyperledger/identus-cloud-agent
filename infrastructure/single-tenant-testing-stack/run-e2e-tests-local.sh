...
export ACME_AGENT_URL=http://localhost:${PORT}/issuer/prism-agent
export ACME_AUTH_KEY=default
export BOB_AGENT_URL=http://localhost:${PORT}/verifier/prism-agent
export BOB_AUTH_KEY=default
export MALLORY_AGENT_URL=http://localhost:${PORT}/holder/prism-agent
export MALLORY_AUTH_KEY=default
export FABER_AGENT_URL=http://localhost:${PORT}/holder/prism-agent
