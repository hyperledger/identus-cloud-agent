...
To start the process, the issuer needs to create a credential offer invitation.
...
<!--
// TODO: didcomm .puml files, edit, then output .png?
// QUESTION: What was used to export .puml => .png?
