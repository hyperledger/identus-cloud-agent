      ...
      _ <- record match {
        ...
        case IssueCredentialRecord(
          ...
          for {
            ...
            credentialService <- ZIO.service[CredentialService]
            _ <- {
              if (resp.status >= 200 && resp.status < 300) notifyIfSuccessful(credentialService.markOfferSent(id))
        ...
        case IssueCredentialRecord(
          ...
          for {
            ...
            credentialService <- ZIO.service[CredentialService]
            _ <- {
              if (resp.status >= 200 && resp.status < 300) notifyIfSuccessful(credentialService.markRequestSent(id))
              else ZIO.fail(ErrorResponseReceivedFromPeerAgent(resp))
            }
          } yield ()
        ...
        case IssueCredentialRecord(
          ...
          for {
            credentialService <- ZIO.service[CredentialService]
            _ <- notifyIfSuccessful(credentialService.acceptCredentialRequest(id))
          } yield ()
        ...
        case IssueCredentialRecord(
          ...
          for {
            ...
            _ <- notifyIfSuccessful(credentialService.markCredentialGenerated(id, issueCredential))
        ...
        case IssueCredentialRecord(
          ...
          for {
            ...
            credentialService <- ZIO.service[CredentialService]
            _ <- {
              if (resp.status >= 200 && resp.status < 300) notifyIfSuccessful(credentialService.markCredentialSent(id))
              else ZIO.fail(ErrorResponseReceivedFromPeerAgent(resp))
            }
          } yield ()
