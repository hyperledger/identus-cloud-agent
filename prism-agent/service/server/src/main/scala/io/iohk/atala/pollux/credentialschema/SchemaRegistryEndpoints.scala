...
object SchemaRegistryEndpoints {
  ...
  private val tagDescription =
    """
      |The Schema Registry is a REST API that allows to publish and lookup credential schemas in [W3C](https://w3c.github.io/vc-json-schema/) and [AnonCreds](https://hyperledger.github.io/anoncreds-spec/#term:schema) formats.
      |The Schema Registry is a part of the [Atala PRISM](https://docs.atalaprism.io/) ecosystem.
      |
      ...
      |The Credential Schema is referenced via `schemaId` field in the issuance and verification flows.
      |
      |Endpoints are secured by `apiKeyAuth` or `jwtAuth` authentication.</p>
      |""".stripMargin
