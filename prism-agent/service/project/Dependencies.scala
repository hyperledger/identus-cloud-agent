...
object Dependencies {
  ...
  private lazy val http4sBlazeServer = "org.http4s" %% "http4s-blaze-server" % "0.23.14"
  ...
  private lazy val sttpClient3ZioJson = "com.softwaremill.sttp.client3" %% "zio-json" % "3.8.13" % Test
