...
import org.hyperledger.identus.issue.controller.http.{AcceptCredentialOfferRequest, CreateIssueCredentialRecordRequest, IssueCredentialRecord, IssueCredentialRecordPage}
...
class IssueControllerImpl(
  ...
  override def getCredentialRecord(
    ...
    mapIssueErrors(result) someOrFail CredentialServiceError.RecordNotFound(DidCommID(recordId))
