...
import org.hyperledger.identus.pollux.credentialschema.http.CredentialSchemaDidUrlResponse.annotations
...
case class CredentialSchemaDidUrlResponse(
    ...
    resource: String,
    @description(annotations.schemaUrl.description)
    @encodedExample(annotations.schemaUrl.example)
    schemaUrl: String,
)
...
//    ,
  ...
  given decoder: zio.json.JsonDecoder[CredentialSchemaDidUrlResponse] =
  ...
  object annotations {
    ...
    object schemaUrl
        extends Annotation[String](
          ...
          example =
            "did:prism:462c4811bf61d7de25b3baf86c5d2f0609b4debe53792d297bf612269bf8593a?resourceService=agent-base-url&resourcePath=schema-registry/schemas/ef3e4135-8fcf-3ce7-b5bb-df37defc13f6&resourceHash=4074bb1a8e0ea45437ad86763cd7e12de3fe8349ef19113df773b0d65c8a9c46"
        )
  }
}
